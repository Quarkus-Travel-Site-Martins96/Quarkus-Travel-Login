(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function zdL(module, __webpack_exports__, __webpack_require__) {
      ...
      var _jwt_decode_vo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./jwt-decode-vo */
      "BW7C");
      /* harmony import */
      ...
      var _cookie_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../cookie-utils */
      "A8sk");
      /* harmony import */
      ...
      function ToolbarComponent_div_8_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function ToolbarComponent_div_8_Template_a_click_4_listener() {
      ...
      var ToolbarComponent = /*#__PURE__*/function () {
        function ToolbarComponent(cookieMng, rest) {
      ...
      ToolbarComponent.ɵfac = function ToolbarComponent_Factory(t) {
        return new (t || ToolbarComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_cookie_utils__WEBPACK_IMPORTED_MODULE_4__["CookieManager"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_rest_service__WEBPACK_IMPORTED_MODULE_5__["RestService"]));
      };

      ToolbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
    ...
    /***/
    function P1i(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var LoginFormComponent = /*#__PURE__*/function () {
        function LoginFormComponent(rest, cookies) {
          ...
          this.loginUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["Environment"].getLoginHost() + '/login';
          this.homePageUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["Environment"].getHomeHost();
        ...
        _createClass(LoginFormComponent, [{
          ...
          value: function login() {
            ...
            this.loginSub = this.rest.sendPostGetRawText(this.loginUrl, {
              ...
              window.location.href = _this2.homePageUrl;
            }, function (error) {
              console.error(error);
      ...
      LoginFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 16,
        vars: 3,
        consts: [[1, "login-content"], [1, "container"], [3, "ngSubmit"], [1, "login-form"], ["for", "username-input"], ["type", "text", "id", "username", "name", "username", 1, "login-input-text", 3, "ngModel", "ngModelChange"], ["for", "password-input"], ["type", "password", "id", "password", "name", "password", 1, "login-input-text", 3, "ngModel", "ngModelChange"], ["type", "submit", 1, "login-btn"], ["class", "error-login", 4, "ngIf"], [1, "error-login"]],
    ...
    /***/
    function A8sk(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CookieManager", function () {
      ...
      var COOKIE_CONSENT = 'allowed-cookie-banner';
      var COOKIE_CONSENT_EXPIRE_DAYS = 180;
      ...
      var CookieManager = /*#__PURE__*/function () {
        ...
        _createClass(CookieManager, [{
          ...
          key: "setCookie",
          value: function setCookie(name, value, expireDays) {
            var path = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
            var d = new Date();
            d.setTime(d.getTime() + expireDays * 24 * 60 * 60 * 1000);
            var expires = "expires=".concat(d.toUTCString());
            var cpath = path ? "; path=".concat(path) : '';
            document.cookie = "".concat(name, "=").concat(value, "; ").concat(expires).concat(cpath);
          }
        }, {
          key: "consent",
          value: function consent(isConsent, e) {
            if (!isConsent) {
      ...
      CookieManager.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
        token: CookieManager,
    ...
    function AytR(module, __webpack_exports__, __webpack_require__) {
      ...
      var Environment = /*#__PURE__*/function () {
        ...
        _createClass(Environment, null, [{
          key: "getHomeHost",
          value: function getHomeHost() {
            return 'http://localhost:8080';
          }
        }, {
          key: "getHotelHost",
          value: function getHotelHost() {
            return 'http://localhost:8081';
          }
        }, {
          key: "getLoginHost",
          value: function getLoginHost() {
            return 'http://localhost:7070';
          }
        }, {
          key: "getUserManagerHost",
          value: function getUserManagerHost() {
      ...
      Environment.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
        token: Environment,
    ...
    /***/
    function BW7C(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function E9uI(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      function AppComponent_div_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("jwt", function AppComponent_div_2_Template_app_login_form_jwt_1_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r2);

            var ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();

            return ctx_r1.updateJWT($event);
          });
      ...
      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(rest, cookies) {
          ...
          if (cookieJWT) {
            //JWT found, check if is valid
            this.rest.sendPost(this.validateUrl, cookieJWT, new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
              'content-type': 'text/plain'
            })).subscribe(function () {
              //JWT correct, move to Home Page
              window.location.href = _this3.homePageUrl;
            }, function (error) {
              //JWT non correct or service not available
              if (error.status === 401) {
                console.error('The token JWT is not valid, relogin required', error);

                _this3.cookies["delete"]('user.jwt');
      ...
      AppComponent.ɵfac = function AppComponent_Factory(t) {
        return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_rest_service__WEBPACK_IMPORTED_MODULE_3__["RestService"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](ngx_cookie_service__WEBPACK_IMPORTED_MODULE_4__["CookieService"]));
      };
      ...
      AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        ...
        decls: 3,
        vars: 1,
        consts: [[1, "toolbar"], ["class", "content", "role", "main", 4, "ngIf"], ["role", "main", 1, "content"], [3, "jwt"], [1, "bg-bubbles", "clear"]],
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineInjector"]({
        ...
        imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵsetNgModuleScope"](AppModule, {
          declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _toolbar_toolbar_component__WEBPACK_IMPORTED_MODULE_3__["ToolbarComponent"], _login_form_login_form_component__WEBPACK_IMPORTED_MODULE_4__["LoginFormComponent"]],
          imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"]]
        });
      })();
      /***/
